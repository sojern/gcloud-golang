...
import fmt "fmt"
import math "math"
import google_bigtable_admin_v21 "github.com/sojern/gcloud-golang/bigtable/internal/table_data_proto"
import sojern_protobuf1 "github.com/sojern/gcloud-golang/protobuf/empty"
...
type ListTablesRequest struct {
	...
	View google_bigtable_admin_v21.Table_View `protobuf:"varint,2,opt,name=view,proto3,enum=google.bigtable.admin.v2.Table_View" json:"view,omitempty"`
...
type BigtableTableAdminClient interface {
	...
	DeleteTable(ctx context.Context, in *DeleteTableRequest, opts ...grpc.CallOption) (*sojern_protobuf1.Empty, error)
	...
	// particular prefix.
	DropRowRange(ctx context.Context, in *DropRowRangeRequest, opts ...grpc.CallOption) (*sojern_protobuf1.Empty, error)
}
...
func (c *bigtableTableAdminClient) DeleteTable(ctx context.Context, in *DeleteTableRequest, opts ...grpc.CallOption) (*sojern_protobuf1.Empty, error) {
	out := new(sojern_protobuf1.Empty)
...
func (c *bigtableTableAdminClient) DropRowRange(ctx context.Context, in *DropRowRangeRequest, opts ...grpc.CallOption) (*sojern_protobuf1.Empty, error) {
	out := new(sojern_protobuf1.Empty)
...
type BigtableTableAdminServer interface {
	...
	// Permanently deletes a specified table and all of its data.
	DeleteTable(context.Context, *DeleteTableRequest) (*sojern_protobuf1.Empty, error)
	// Atomically performs a series of column family modifications
	// on the specified table.
	...
	// specify whether to delete all rows in a table, or only those that match a
	// particular prefix.
	DropRowRange(context.Context, *DropRowRangeRequest) (*sojern_protobuf1.Empty, error)
}
...
var _BigtableTableAdmin_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: fileDescriptorBigtableTableAdmin,
}
...
func (m *CreateTableRequest) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Table == nil {
				m.Table = &google_bigtable_admin_v21.Table{}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.View |= (google_bigtable_admin_v21.Table_View(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ListTablesResponse) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Tables = append(m.Tables, &google_bigtable_admin_v21.Table{})
...
func (m *ModifyColumnFamiliesRequest_Modification) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			v := &google_bigtable_admin_v21.ColumnFamily{}
...
var fileDescriptorBigtableTableAdmin = []byte{
	...
	,
}
